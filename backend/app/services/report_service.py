...
DEBT_FONT = Font(color="C00000")   # red
CREDIT_FONT = Font(color="0070C0")  # blue


def build_monthly_report_xlsx(summary: list[dict], month: int, year: int) -> bytes:
...
def _build_resumen(ws: Worksheet, summary: list[dict], period: str) -> None:
    ws.title = "Resumen"
...
def _build_detalle(ws: Worksheet, summary: list[dict], period: str) -> None:
