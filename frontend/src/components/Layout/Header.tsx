        ...
        <div className="flex h-16 items-center justify-between">
          <div className="flex items-center gap-8">
            <Link to="/" className="flex items-center gap-3 text-primary font-bold text-xl">
              ...
              <span className="hidden md:block text-slate-900">Pulse</span>
            </Link>
          ...
          <div className="flex items-center gap-3">
            <Link
              to="/alerts"
              className="flex items-center justify-center size-9 rounded-lg bg-slate-100 text-slate-600 hover:bg-slate-200 transition-colors"
            >
